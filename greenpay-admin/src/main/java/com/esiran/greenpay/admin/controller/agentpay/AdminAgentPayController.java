...
@Controller
@RequestMapping("/admin/agentpay")
public class AdminAgentPayController {
    private final IOrderService orderService;
    private final IOrderDetailService orderDetailService;
    public AdminAgentPayController(
    ...
    @GetMapping("/list")
    public String list(){
        return "admin/agentpay/list";
    }
    @GetMapping("/passage")
    public String passage(){
        return "admin/agentpay/passage";
    }
