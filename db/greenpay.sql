...
INSERT INTO `merchant_pay_account` VALUES (1,2,0,0,'2020-04-17 00:54:21','2020-04-17 00:54:21');
...
INSERT INTO `merchant_product` VALUES (1,2,'wx_jsapi',2,0.0015,1,'2020-04-20 23:23:55','2020-04-20 23:23:55');
...
CREATE TABLE `pay_extract` (
  ...
  `status` int(1) NOT NULL COMMENT '提现状态 0 待审核 ，1提现成功，-1提现失败',
...
INSERT INTO `pay_order` VALUES (13,'1250458836519751680','202004161219536850645',2,123456,'123484','12346546',1,NULL,0,NULL,NULL,0,NULL,NULL,'2020-04-16 00:19:54','2020-04-16 00:19:54');
INSERT INTO `pay_order` VALUES (14,'1252256726720319488','202004201124041122618',2,123456,'123484','1587396162157',1,NULL,0,NULL,NULL,0,NULL,NULL,'2020-04-20 23:24:04','2020-04-20 23:24:04');
INSERT INTO `pay_order` VALUES (15,'1252257359594655744','202004201126350011901',2,123456,'123484','15873961621573',1,NULL,0,NULL,NULL,0,NULL,NULL,'2020-04-20 23:26:35','2020-04-20 23:26:35');
INSERT INTO `pay_order` VALUES (16,'1252258238792077312','202004201130046184519',2,123456,'123484','1587396593921',1,NULL,0,NULL,NULL,0,NULL,NULL,'2020-04-20 23:30:05','2020-04-20 23:30:05');
...
CREATE TABLE `pay_passage_account` (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='支付通道账户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pay_passage_account` VALUES (3,'wx_jsapi',2,'ABC','',0,'2020-04-24 19:59:21','2020-04-24 19:59:21');
...
INSERT INTO `pay_product` VALUES (2,'支付宝服务窗_忆思然',1,'ali_jsapi',1,2,2,0,'2020-04-14 02:08:38','2020-04-24 22:54:35');
INSERT INTO `pay_product` VALUES (3,'微信JSAPI_鸿宇通道',1,'wx_jsapi',1,2,2,1,'2020-04-21 20:02:43','2020-04-24 22:17:50');
INSERT INTO `pay_product` VALUES (4,'abc',1,'wx_jsapi',2,2,2,1,'2020-04-24 20:59:25','2020-04-24 22:05:46');
...
INSERT INTO `pay_type` VALUES (4,'ali_scan','支付宝二维码',2,1,'2020-04-23 17:44:43','2020-04-23 17:44:43');
...
CREATE TABLE `replacepay_order` (
  ...
  `replace_money` bigint(255) NOT NULL COMMENT '代付金额',
  `status` int(1) NOT NULL COMMENT '订单状态 0 待审核 1 审核通过 -1 审核失败',
...
CREATE TABLE `replacepay_recharge` (
  ...
  `mch_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '商户id',
  `recharge_money` bigint(255) NOT NULL COMMENT '充值金额',
  `status` int(1) NOT NULL COMMENT '充值订单状态 0 待审核 1 充值成功 -1 未充值',
  `created_at` datetime NOT NULL COMMENT '创建时间',
...
INSERT INTO `system_menu` VALUES (2,'用户列表','system:users',1,NULL,'/admin/system/users',1,0,NULL,'2020-04-22 17:10:11','2020-04-22 17:10:11');
...
INSERT INTO `system_role` VALUES (1,'admin','1,2,3,4,5,6','2020-04-21 17:59:10','2020-04-21 17:59:10');
INSERT INTO `system_role` VALUES (4,'a','a','2020-04-24 18:05:04','2020-04-24 18:05:04');
INSERT INTO `system_role` VALUES (5,'a','a','2020-04-24 18:05:04','2020-04-24 18:05:04');
...
INSERT INTO `system_role_menu` VALUES (1,1,1,'2020-04-22 17:05:53','2020-04-22 17:05:53');
INSERT INTO `system_role_menu` VALUES (2,1,2,'2020-04-22 17:17:05','2020-04-22 17:17:05');
INSERT INTO `system_role_menu` VALUES (3,1,3,'2020-04-22 17:18:11','2020-04-22 17:18:11');
INSERT INTO `system_role_menu` VALUES (4,1,4,'2020-04-22 17:18:23','2020-04-22 17:18:23');
INSERT INTO `system_role_menu` VALUES (5,1,5,'2020-04-22 17:18:27','2020-04-22 17:18:27');
INSERT INTO `system_role_menu` VALUES (6,1,6,'2020-04-22 17:18:38','2020-04-22 17:18:38');
INSERT INTO `system_role_menu` VALUES (7,1,7,'2020-04-22 18:40:14','2020-04-22 18:40:14');
...
-- Dump completed on 2020-04-24 23:28:41
